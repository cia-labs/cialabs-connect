...
export default function ShortsHighlightsView() {
    ...
    const videoUrls = [
        { url: "https://youtube.com/shorts/rwfQ81mhkuQ?si=I4fZK6JOMneoqlWn", title: "Project Alpha Showcase" },
        { url: "https://youtube.com/shorts/y-zx4ZI-qz4?si=QOiv6rrmu1rhlFzD", title: "Drone Flight Test" },
        { url: "https://youtu.be/pD6GEjKkvsc?si=y4pymLhJMeqJYtXA", title: "Web App Demo" },
    ];
